...
a small notebook on the open web — fixed-width, two-column, pale sage paper with a deep burgundy sidebar and brass accents. botanical-bookbinding palette. for personal sites in the slow / commonplace-book mode: short notes in the middle, a "now" block + links on the side, a chronological log down the page.
